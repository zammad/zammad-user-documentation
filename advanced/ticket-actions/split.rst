...
.. figure:: /images/advanced/ticket-actions/split-dialog.png
   :alt: Screenshot shows split ticket dialog
   :align: center
   :scale: 90%

It is prefilled with the content of the existing article. Remember to select the
type (call/email). The original ticket is :doc:`linked <link>` in the new one and
vice versa. You can find the linked tickets in the ticket sidebar tab under
**Related tickets**.
